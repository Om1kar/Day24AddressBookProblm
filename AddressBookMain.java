...
//          create object for map class object name is addressBookMap
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                     ...
                     */
                    AddressBookSystem.main(addressBookMap.get(bookName));
                    break;
                case 2:
                     ...
                     */
                    AddressBookSystem.main(addressBookMap.get(name));
                    break;
                case 3:
